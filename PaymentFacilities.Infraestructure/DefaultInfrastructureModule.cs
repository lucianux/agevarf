...
using PaymentFacilities.Infrastructure.Data;
using PaymentFacilities.SharedKernel.Interfaces;
using Module = Autofac.Module;
using MediatR;
using MediatR.Pipeline;

namespace PaymentFacilities.Infraestructure
{
    public class DefaultInfrastructureModule : Module
    {
        ...
        public DefaultInfrastructureModule(bool isDevelopment, Assembly callingAssembly =  null)
        {
            ...
            var infrastructureAssembly = Assembly.GetAssembly(typeof(MongoDBRepository));
